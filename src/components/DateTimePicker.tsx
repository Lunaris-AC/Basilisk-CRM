...
export function DateTimePicker({ value, onChange, placeholder = 'Sélectionner une date', disabled, minDate }: DateTimePickerProps) {
    ...
    return (
        <Popover open={open} onOpenChange={setOpen}>
            ...
            <PopoverContent className="w-auto p-0 bg-zinc-900/95 backdrop-blur-xl border-white/10 shadow-2xl shadow-black/50" align="start" sideOffset={8}>
                <div className="p-1">
                    <Calendar
                        mode="single"
                ...
                <div className="border-t border-white/10 p-4 flex items-center gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <select
                            ...
                            className="bg-black/60 border border-white/10 text-white rounded-lg px-2 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-amber-500/30 appearance-none cursor-pointer hover:border-amber-500/30 transition-colors"
                        >
                    ...
                    <span className="text-white/30 text-xs ml-auto">Heure de reprise</span>
                </div>
            </PopoverContent>
        </Popover>
    )
